...
const GlobalPageLoader = () => (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-lh-dark">
        ...
        <div className="flex flex-col items-center gap-3">
            ...
            <span className="text-[9px] font-bold text-gray-500 uppercase tracking-widest italic">Optimizing Operational Catalog</span>
        </div>
    </div>
);
            ...
            <div className="max-w-[1400px] mx-auto w-full pt-4 relative z-10">
                <div className="mb-12 flex items-center gap-8">
                    <motion.div
                        ...
                        className="w-20 h-20 bg-lh-purple/10 rounded-3xl border border-lh-purple/20 p-2 flex items-center justify-center relative group"
                    >
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <span className="text-[10px] font-black text-lh-purple uppercase tracking-[0.5em] italic">Operational_Registry</span>
                        </div>
                        <h1 className="text-5xl md:text-6xl font-black text-white tracking-tighter uppercase italic leading-none">Find <span className="text-transparent font-black" style={{ WebkitTextStroke: '1px #bc13fe' }}>an Exam</span></h1>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <PrecisionPanel className="p-10 border-white/5 shadow-2xl">
                            <h3 className="text-[12px] font-black text-lh-purple uppercase tracking-[0.4em] mb-8 flex items-center gap-3 italic">
                                        ...
                                        {filteredExams.map((exam, idx) => (
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <span className="text-[11px] font-black text-gray-400 group-hover/item:text-white uppercase tracking-widest italic transition-colors">{exam}</span>
                                                </div>
                        ...
                        <PrecisionPanel className="p-10 bg-lh-purple/5 border-lh-purple/10 relative overflow-hidden group/voucher">
                            {/* Small mascot accent */}
                            ...
                            <div className="flex justify-between items-start mb-6 relative z-10">
                                <h3 className="text-[10px] font-black text-white uppercase tracking-[0.4em] flex items-center gap-3 italic">
                            ...
                            <p className="text-[11px] text-gray-400 font-bold uppercase tracking-widest leading-relaxed mb-8 italic relative z-10 opacity-70">
                    ...
                    <div className="lg:col-span-8 space-y-8">
                        <PrecisionPanel className="p-10 border-white/5 shadow-2xl">
                            <div className="mb-10 p-8 bg-white/[0.02] border border-white/10 rounded-[2rem] border-l-4 border-l-lh-purple relative group/note">
                                <p className="text-[13px] text-gray-400 font-bold leading-relaxed italic opacity-80 group-hover:opacity-100 transition-opacity">
                                    Select a certification group below to view specific examination parameters and proceed with the registration sequence. <br />
                                ...
                                {filteredExams.map((exam, idx) => (
                                    <div key={idx} className="space-y-px">
                                        <motion.button
                                            ...
                                            className={`w-full flex items-center justify-between p-8 rounded-[2rem] transition-all duration-500 border ${activeGroup === idx ? 'bg-lh-purple/10 border-lh-purple/30 text-white shadow-[0_20px_50px_rgba(188,19,254,0.1)]' : 'bg-white/[0.03] border-white/5 text-gray-500 hover:bg-white/10 hover:border-white/20 hover:text-white'} group/row`}
                                        >
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div className="text-left">
                                                    <span className="text-[14px] font-black uppercase tracking-[0.3em] font-mono italic block mb-1">{exam}</span>
                                                ...
                                                >
                                                    <div className="p-6 pt-2 space-y-3">
                                                        <motion.button
                                                            ...
                                                            onClick={() => navigate('/dashboard/select-exam-options', { state: { examName: exam } })}
                                                            className="w-full text-left p-6 rounded-[1.5rem] bg-white/[0.03] hover:bg-lh-purple/20 border border-white/10 hover:border-lh-purple/40 transition-all group/action flex items-center justify-between shadow-lg"
                                                        >
                                                            <div className="flex items-center gap-5">
                                                                ...
                                                                <div>
                                                                    <span className="text-[12px] font-black uppercase tracking-widest text-white block mb-1">Schedule_Exam_Now</span>
                                                                    <span className="text-[9px] font-bold text-gray-500 uppercase tracking-widest block italic opacity-60">Initiate Secure Pearson VUE Interface</span>
                                                                </div>
                                                            </div>
                                                            <ArrowRight size={18} className="text-lh-purple opacity-40 group-hover/action:opacity-100 group-hover/action:translate-x-4 transition-all" />
                                                        </motion.button>
                                                    </div>
                                                </motion.div>
                                            )}
                                ...
                                {filteredExams.length === 0 && (
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <p className="text-gray-500 text-[12px] font-black uppercase tracking-[0.6em] italic opacity-60">No matching registry entries detected</p>
                                        </div>
                                    </motion.div>
                                )}
                            </div>
