...
import {
    Shield, ChevronLeft, Calendar, Clock, Globe, Check, XCircle, ChevronRight, ArrowRight, Sun, Sunrise, Sunset, Moon, ChevronDown
} from 'lucide-react';
...
const FindAppointment = () => {
    ...
    const timeGroups = [
        { id: 0, label: '00:00 - 05:00', available: 2, icon: Moon, color: 'from-slate-900 to-lh-purple/20', slots: ['03:45', '04:15'] },
        { id: 1, label: '05:15 - 09:00', available: 5, icon: Sunrise, color: 'from-lh-purple/40 to-yellow-500/20', slots: ['05:15', '05:30', '05:45', '06:00', '06:15'] },
        { id: 2, label: '09:15 - 13:00', available: 0, icon: Sun, color: 'from-lh-purple/30 to-white/5', slots: [] },
        { id: 3, label: '13:15 - 17:00', available: 0, icon: Sunset, color: 'from-lh-purple/50 to-orange-500/10', slots: [] }
    ];
    ...
    const handleBookAppointment = () => {
        navigate('/dashboard/review-booking', {
            state: {
                ...
                appointmentDate: selectedDate ? `2026-02-${selectedDate}` : null,
        ...
        <div className="min-h-full flex flex-col relative pb-12">
            <div className="max-w-[1000px] mx-auto w-full pt-4 space-y-6">
                ...
                <div className="space-y-2">
                    <h2 className="text-4xl font-black italic uppercase tracking-tighter">Find an <span className="text-lh-purple text-transparent" style={{ WebkitTextStroke: '1px #bc13fe' }}>appointment</span></h2>
                </div>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className={`transition-all duration-500 ${isTimeZoneConfirmed ? 'opacity-30 pointer-events-none scale-95 blur-[1px]' : 'opacity-100'}`}>
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h4 className="text-sm font-black text-white uppercase tracking-widest italic">1. Confirm session time zone</h4>
                            </div>

                            <div className="pl-9 space-y-5">
                                <div className="flex items-center gap-4">
                                    <span className="text-xl font-black text-lh-purple bg-lh-purple/10 px-4 py-2 rounded-xl italic border border-lh-purple/20">
                                        {detectedTimeZone}
                                    </span>
                                    <span className="text-gray-500 text-[10px] font-bold uppercase tracking-widest">({currentTime})</span>
                                </div>
                                <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest max-w-lg italic">
                        ...
                        {isTimeZoneConfirmed && (
                            ...
                            >
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h4 className="text-sm font-black text-white uppercase tracking-widest italic">2. Select operational date</h4>
                                </div>
                                ...
                                <div className="pl-9 space-y-6">
                                    <div className="max-w-sm bg-black/40 border border-white/10 rounded-[2rem] p-6 shadow-2xl relative overflow-hidden">
                                        ...
                                        <div className="flex items-center justify-between mb-6">
                                            <span className="text-[11px] font-black text-white uppercase tracking-[0.3em] italic">February 2026</span>
                                        ...
                                        <div className="grid grid-cols-7 gap-1 text-center mb-2">
                                            ...
                                            {[...Array(31)].map((_, i) => {
                                                const d = i + 1;
                                                const avail = [12, 14, 15, 20, 21, 24].includes(d);
                                                return (
                                                    <button
                                                        key={i}
                                                        disabled={!avail}
                                    ...
                                    {selectedDate && (
                                        <button onClick={() => setSelectedDate(null)} className="text-[9px] font-black text-lh-purple uppercase tracking-widest flex items-center gap-2 italic hover:text-white transition-colors">
                        ...
                        {selectedDate && (
                            ...
                            >
                                <div className="flex items-center gap-4 mb-6 border-t border-white/5 pt-8">
                                    ...
                                    <h4 className="text-sm font-black text-white uppercase tracking-widest italic">3. Configure Session Time</h4>
                                </div>
                        ...
                        >
                            <div className="p-8 border-b border-white/5 bg-lh-purple/5 flex items-center justify-between">
                                <div className="space-y-1">
                                    <h3 className="text-xl font-black text-white uppercase italic tracking-tighter leading-none">Session_Relays</h3>
