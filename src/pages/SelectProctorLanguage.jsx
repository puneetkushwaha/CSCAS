...
const SelectProctorLanguage = () => {
    ...
    const { examName, examId, price, temporaryCountry, hasAuthorization, selectedLanguage, selectedOption } = location.state || {};
        ...
        <div className="min-h-full flex flex-col relative pb-12">
            <div className="max-w-[1000px] mx-auto w-full pt-4 space-y-8">
                ...
                <div className="space-y-3">
                    <h2 className="text-4xl font-black uppercase tracking-tighter">Select <span className="text-lh-purple text-transparent" style={{ WebkitTextStroke: '1px #bc13fe' }}>proctor language</span></h2>
                </div>
